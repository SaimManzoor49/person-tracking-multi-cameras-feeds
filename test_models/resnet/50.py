...
for _ in range(60):
    ...
    output_features = model.forward_features(input_tensor)  # (1, 2048) shaped tensor
...
# Total time taken to extract features from 60 images: 20.7588 seconds
# Average time per extraction: 0.3460 seconds